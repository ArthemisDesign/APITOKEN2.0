...
## 0. Прежде чем открыть первый файл
...
## 4. Типы наблюдений — `crates/registry/src/<provider>_calibration.rs`
...
## 5. Credential — `crates/<provider>-credential`
...
## 6. Estimator — `crates/forward/src/<provider>_calibration.rs`
...
## 8. Runtime, server, observability
...
## 9. Документация — в том же коммите
...
## 11. Что нельзя объявлять готовым
