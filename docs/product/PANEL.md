...
- Пользователи: серверный поиск/фильтры и bounded pagination, серверная сортировка
  ...
  effective global/provider/model discount, 2FA, начисление баланса, revoke всех сессий, сброс 2FA,
  enable/disable. Карточки
...
- Финансы: prepay-метрики одним экраном — выручка 30 дней с дельтой к предыдущим 30, ARPU/ARPPU,
  доля платящих и распределение клиентов по effective discount/source rule; SVG-график выручки по
  дням (окна 7/30/90) с
