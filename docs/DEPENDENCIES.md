...
| `apps/openkeys` (admin API) | `/api/internal/admin/*` via Caddy `admin.apitoken.sale/openkeys-admin/*`, header `X-OpenKeys-Control-Key` | `apps/admin` | `docs/product/OPENKEYS.md` |
