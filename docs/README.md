...
- [QUOTA_DISTRIBUTION_ANALYSIS.md](engine/QUOTA_DISTRIBUTION_ANALYSIS.md) — аналитический снапшот: распределение запросов по подписочным квотам (Claude 5h/7d, Codex weekly, Gemini per-model buckets, Kimi 5h+weekly) и предложения по эффективности трат при сохранении cache-аффинити.
