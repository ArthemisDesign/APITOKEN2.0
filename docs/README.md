...
- [STAGING_ENVIRONMENT.md](ops/STAGING_ENVIRONMENT.md) — staging implementation plan (v8 lock 2026-08-22, v9 implementation status 2026-08-23): architecture, invariants, inventory, locked decisions. Phases 1–7 are on `master`; twin v1 is mock-first; Phase 8 is owner gate. Pair: [STAGING_AGENT_PLAN.md](ops/STAGING_AGENT_PLAN.md). Kickoff: [STAGING_AGENT_PROMPT.md](ops/STAGING_AGENT_PROMPT.md).
- [STAGING_AGENT_PLAN.md](ops/STAGING_AGENT_PLAN.md) — binding execution plan for the staging twin. Another agent must follow this file and update it in the same commit as the work (status board, checklists, SHA journal). Do not start Phase 8. Architecture stays in STAGING_ENVIRONMENT.
