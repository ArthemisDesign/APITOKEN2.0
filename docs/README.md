...
- [STAGING_ENVIRONMENT.md](ops/STAGING_ENVIRONMENT.md) — staging implementation plan (v8, owner-approved 2026-08-22, not implemented): architecture, invariants, inventory, locked decisions. Pair: [STAGING_AGENT_PLAN.md](ops/STAGING_AGENT_PLAN.md).
