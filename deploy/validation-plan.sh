...
policy_sha256=$(
  for path in \
    ...
    deploy/stage-live-proxy.py \
    deploy/stage-live-host-proxy.py \
    deploy/stage-live-control.sh \
    ...
    systemd/apitoken-stage-live-host-proxy.service \
    systemd/apitoken-stage-live-client.service \
