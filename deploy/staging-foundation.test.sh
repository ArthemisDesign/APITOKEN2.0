...
grep -Fq 'systemctl enable apitoken-stage-source-fetch.timer apitoken-stage-watchdog.timer' "$ROOT/deploy/install-watchdog.sh"
grep -Fq 'systemctl start apitoken-stage-source-fetch.timer apitoken-stage-watchdog.timer' "$ROOT/deploy/install-watchdog.sh"
