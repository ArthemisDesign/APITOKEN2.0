...
require_permitted 'GPT Image 2 exact-producer public preflight inspector' \
  /usr/local/lib/apitoken-watchdog/controller/gpt-image-2-public-preflight-gate.sh \
  d42fc0e3290c0042a16797626326c250e0f6721c --inspect
require_permitted 'GPT Image 2 exact-producer public preflight v2 gate' \
  /usr/local/lib/apitoken-watchdog/controller/gpt-image-2-public-preflight-v2-gate.sh \
  6629ecd7b3725bcd7306ef7a1dc8675ef9160a43
...
require_permitted 'GPT Image 2 exact-producer public paid smoke v3 gate' \
  /usr/local/lib/apitoken-watchdog/controller/gpt-image-2-public-paid-smoke-v3-gate.sh \
  8b68d73a2a6ba6ffae2f24692b283059f15b7c63
require_permitted 'GPT Image 2 exact-producer surface probe gate' \
  /usr/local/lib/apitoken-watchdog/controller/gpt-image-2-surface-probe-gate.sh \
  d69868fb700aaeb9b6723d8780bb29be4aab9c0d
...
require_permitted 'router large-payload candidate gate' \
  ...
  /var/lib/apitoken/spool/router-8801 6442450944 /var/lib/apitoken/watchdog/large-payload \
