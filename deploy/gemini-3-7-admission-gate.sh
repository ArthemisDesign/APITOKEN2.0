...
UNIT_SHA256=7af20848cb5b018dedaf55e08905f1ffb5cb6c4f4742985e1039b96e63fa95b3
...
cleanup() {
  ...
  if (( CANARY_OWNED == 1 )); then
    if ! $TIMEOUT "$CANARY_STOP_TIMEOUT_SEC" $SYSTEMCTL stop "$UNIT" >/dev/null 2>&1; then
