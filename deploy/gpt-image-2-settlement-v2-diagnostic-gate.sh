...
DIAGNOSTIC_PRODUCER_SHA=853fdc6c8d5be486c371b23df6772eeaf7a48029
FENCED_PRODUCER_SHA=853fdc6c8d5be486c371b23df6772eeaf7a48029
EVIDENCE_PARENT=$STATE_ROOT/gpt-image-2-public-paid-smoke-v2
OUTPUT=$EVIDENCE_PARENT/$FENCED_PRODUCER_SHA

[[ $# -eq 2 && $2 == --inspect ]] \
  || wd_die "usage: gpt-image-2-settlement-v2-diagnostic-gate.sh <exact-diagnostic-producer-sha> --inspect"
SHA=$1
wd_validate_sha "$SHA"
