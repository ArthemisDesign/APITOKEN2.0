...
CANDIDATE_ROOT=${SALES_CANDIDATE_ROOT:-$CONTOUR_ROOTS_CANDIDATE}
RELEASE_ROOT=${SALES_RELEASE_ROOT:-$CONTOUR_ROOTS_SALES_RELEASE}
ENV_FILE=${SALES_ENV_FILE:-$CONTOUR_ROOTS_CONFIG/sales.env}
API_UNIT=$CONTOUR_UNITS_SALES_API
WEB_UNIT=$CONTOUR_UNITS_SALES_WEB
API_HEALTH=${SALES_API_HEALTH:-$CONTOUR_ORIGINS_SALES_API/v1/health}
WEB_HEALTH=${SALES_WEB_HEALTH:-$CONTOUR_ORIGINS_SALES_WEB/}
WEB_LOGIN=${SALES_WEB_LOGIN:-$CONTOUR_ORIGINS_SALES_WEB/login}
API_TELEGRAM_CONFIG=${SALES_API_TELEGRAM_CONFIG:-$CONTOUR_ORIGINS_SALES_API/v1/auth/telegram/config}
COMMERCE_BALANCER_URL=${COMMERCE_BALANCER_URL:-$CONTOUR_ORIGINS_COMMERCE_STABLE}
HEALTH_RETRIES=${SALES_HEALTH_RETRIES:-30}
HEALTH_INTERVAL=${SALES_HEALTH_INTERVAL:-2}
STATE_ROOT=${SALES_STATE_ROOT:-$CONTOUR_ROOTS_STATE}
