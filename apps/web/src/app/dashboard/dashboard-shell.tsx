...
const NAV_ICONS = {
  ...
  network: <><circle cx="12" cy="5" r="2.5" /><circle cx="5" cy="18" r="2.5" /><circle cx="19" cy="18" r="2.5" /><path d="M10.8 7.2 6.3 15.8" /><path d="m13.2 7.2 4.5 8.6" /><path d="M7.5 18h9" /></>,
...
const navigation: readonly NavigationItem[] = [
  ...
  { section: "referral", label: "navReferral", icon: "network" },
