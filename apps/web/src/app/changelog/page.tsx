...
const entries = [
  { date: "2026-07", title: "Pricing simplified — one flat 50% discount", body: "The top-up tier ladder is retired. Every account now gets the same flat 50% discount off official Anthropic and OpenAI list prices, on every model, with no thresholds, holds or conditions." },
  { date: "2026-07", title: "GPT-5.6 on the same key — apiToken.sale is now multi-provider", body: "The OpenAI-compatible API at openai.api.apitoken.sale/v1 serves the GPT-5.6 line (sol, terra, luna), gpt-5.5 and gpt-5.4 through Responses and Chat Completions with SSE streaming. One sk-pool key, one prepaid balance and the same account discount cover both Claude and GPT." },
  ...
  { date: "2026-05", title: "Progressive discount tiers (retired 2026-07)", body: "An earlier pricing model tied the discount to cumulative top-ups. It has since been replaced by the flat 50% discount for every account." },
];
