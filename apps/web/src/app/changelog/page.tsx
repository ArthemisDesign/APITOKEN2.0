...
const entries = [
  { date: "2026-07", title: "Pricing simplified — one flat 50% discount", body: "Every account now gets the same flat 50% discount off official Anthropic and OpenAI list prices, on every model and at every top-up amount." },
