...
import { LocalizedLink, T } from "@/components/translated";
...
const faqItems = [
  ...
  { question: "q3", answer: "a3", q: "Which models are available?", a: "The Claude line — Opus 5, Fable 5, Opus 4.8, Opus 4.7, Sonnet 5, Sonnet 4.6 and Haiku 4.5 — plus the GPT line — GPT-5.6 Sol, Terra and Luna, GPT-5.5 and GPT-5.4 — and the Gemini line — Gemini 3.7 Flash, 3.6 Flash, 3.5 Flash, 3 Flash Preview, 3.1 Pro Preview and more. One balance and one API key cover every model." },
  ...
  { question: "q5", answer: "a5", q: "What base URL should I use?", a: "Use the unified router at https://router.apitoken.sale. Native lanes: POST /v1/messages (x-api-key) for Claude and Anthropic-compatible tools, POST /v1/responses for GPT (Authorization: Bearer), and /v1beta/models/{model}:generateContent for Gemini (x-goog-api-key). The OpenAI-compatible universal lane POST /v1/chat/completions reaches any catalog model, and GET /v1/models lists the unified catalog. Legacy per-provider hosts (api.apitoken.sale, openai.api.apitoken.sale/v1, gemini.api.apitoken.sale) remain supported for existing integrations." },
  ...
  return <><JsonLd data={homeJsonLd} /><main>
      ...
      <section className="cta-band"><div className="wrap cta-row reveal">
        ...
        <div className="cta-actions">
          <LocalizedLink className="btn btn-primary" href="/register"><T k="hero_cta1">Get API key</T></LocalizedLink>
