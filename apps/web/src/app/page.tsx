    ...
    <main>
      ...
      <section id="products"><div className="wrap"><div className="prod-grid" data-reveal-stagger>
        ...
        <div className="prod prod-feat">
          ...
          <div className="prod-body"><TopUpAmountInput className="amount-example" initialAmount="37" showReceive /><T k="pc2_p" as="p">Enter any whole USD amount. No fixed product catalog.</T></div>
