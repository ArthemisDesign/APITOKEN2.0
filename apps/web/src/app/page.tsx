...
const faqItems = [
  ...
  { question: "q3", answer: "a3", q: "Which models are available?", a: "The Claude line — Opus 5, Fable 5, Opus 4.8, Opus 4.7, Sonnet 5, Sonnet 4.6 and Haiku 4.5 — plus the GPT line — GPT-5.6 Sol, Terra and Luna, GPT-5.5 and GPT-5.4 — and the Gemini line — Gemini 3.6 Flash, 3.5 Flash, 3 Flash Preview, 3.1 Pro Preview and more. One balance and one API key cover every model." },
