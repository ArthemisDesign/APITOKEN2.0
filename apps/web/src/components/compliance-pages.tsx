      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "A new eligible B2C account may receive promotional credit equal to $10 of usage at official API prices under the flat 50% discount, represented as $5 of platform balance. Promotional credit has no cash value, cannot be withdrawn or transferred, and is limited to one eligible customer.",
