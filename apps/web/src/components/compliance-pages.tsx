      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "A new eligible B2C account may receive $5 of platform welcome credit. Promotional credit has no cash value, cannot be withdrawn or transferred, and is limited to one eligible customer.",
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            ...
            "Новый подходящий B2C-аккаунт может получить приветственный бонус $5 на баланс платформы. Бонус не имеет денежной стоимости, не выводится и не передаётся, предоставляется один раз одному подходящему клиенту и может быть отменён при дублях аккаунтов, мошенничестве или злоупотреблении.",
          ],
        },
        {
          title: "7. Возвраты",
