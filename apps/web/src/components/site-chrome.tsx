  ...
  return <footer className="site-foot-full">
    <div className="wrap foot-inner">
      <div className="foot-grid">
        ...
        <div className="foot-col"><T k="foot_support" as="h4">Support</T><Link href={l("/support")}><T k="foot_support">Customer support</T></Link><Link href={l("/docs/learn")}>Guides</Link><Link href="/docs/errors">Error codes</Link><Link href="/about">About</Link><Link href="/contacts">Contacts</Link><Link href="/changelog">Changelog</Link><Link href="/status">Status</Link><a href="mailto:apitokensale@gmail.com">apitokensale@gmail.com</a></div>
