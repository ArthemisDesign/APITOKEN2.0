    ...
    sections: [
      ...
      { h2: "费率表：每 100 万 token 各档实际多少钱", blocks: [
        ...
        { type: "table", headers: ["档位", "Model ID", "官方 输入 / 缓存 / 输出", "五折后价格"], rows: [
          ...
          ["Flash", "gemini-3.6-flash", "$0.75 / $0.075 / $3.75 促销价", "$0.375 / $0.0375 / $1.875"],
        ...
        { type: "note", text: "Gemini 3.6 Flash 使用 Google $0.75/$0.075/$3.75 促销价至 2026-12-31，并于 2027-01-01 恢复 $1.50/$0.15/$7.50。缓存输入是按新输入费率 10% 单列的 usage 项，不会与同一批 token 的新输入叠加。" },
      ] },
