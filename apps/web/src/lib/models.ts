...
export const geminiModels: GeminiModel[] = [
  {
    ...
    notes: [
      ...
      "Function calling, JSON structured output, image input and implicit prompt caching are live-proven on the same wire; audio input is not available on this route.",
    ...
    faq: [
      ...
      { q: "Which capabilities are currently published?", a: "Text and image input, function calling, JSON structured output, implicit prompt caching, countTokens and incremental SSE streaming, plus explicit thinking levels low, medium and high through reasoning_effort." },
    ],
    related: ["openai-api-quickstart", "how-billing-works", "why-choose-apitoken"],
  },
  {
