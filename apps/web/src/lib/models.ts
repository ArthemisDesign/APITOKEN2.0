...
export const geminiModels: GeminiModel[] = [
  ...
  },
  {
    ...
    dek: "Gemini 3 Flash Preview is Google's fast multimodal Gemini 3 model for agentic coding, tool use and long-context work at a lower token price than newer Flash generations.",
    inputPerM: 0.5,
    ...
    notes: [
      "Preview model: pin the exact ID and validate behavior before a production migration.",
      "Cached text input bills at $0.05 per 1M; audio input and cached audio use their separate official rates.",
    ],
    faq: [
