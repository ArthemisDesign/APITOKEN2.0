...
export const coreRu: Record<string, Localized> = {
  home: {
    ...
    description: "Доступ к API Claude и GPT со скидкой — один ключ и предоплаченный баланс для Claude Opus, Sonnet, Haiku и линейки GPT-5. Anthropic API и OpenAI-совместимый API дешевле на 50%, готовы для Claude Code, Codex и Cursor.",
  },
  models: {
  ...
  plans: {
    ...
    description: "Гибкие пополнения в USD, единая скидка 50% без тиров и порогов, оценка официальной ценности API и договорные B2B-цены для моделей Claude и GPT.",
  },
  privacy: {
