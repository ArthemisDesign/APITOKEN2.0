...
export const learnKo: Record<string, LocalizedContent> = {
  ...
  "claude-api-free-trial": {
    ...
    faq: [
      ...
      { q: "무료 사용량이 소진되면 어떻게 되나요?", a: "달러 단위 정수 금액을 충전하면 계속 사용할 수 있으며, 고정 50% 할인이 즉시 적용됩니다." },
    ],
  },
  ...
  "claude-api-pricing-explained": {
    ...
    description: "Claude API 가격 이해하기: 토큰당 입력·출력 요율, 프롬프트 캐싱, 그리고 apiToken.sale의 고정 50% 할인.",
  ...
  "how-billing-works": {
    ...
    h1: "과금은 어떻게 작동하는가",
    description: "apiToken.sale 과금 이해하기: 선불 잔액, 공식 요율의 요청 단위 측정, 고정 50% 할인, 대시보드의 토큰 단위 사용량.",
  ...
  "apitoken-vs-proxyapi": {
    ...
    sections: [
      ...
      { h2: "각각 언제 맞을까", blocks: [
        { type: "list", items: [
          "apitoken.sale — 고정 50% 할인, 키의 평생 누적 지출 한도, 선택 가능한 만료일을 갖춘 네이티브 Anthropic 엔드포인트.",
