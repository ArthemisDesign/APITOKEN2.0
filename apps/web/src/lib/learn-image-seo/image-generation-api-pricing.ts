...
export const spec: ImageSeoSpec = {
    ...
    title: tr(
      "Image Generation API Pricing: Token Rates, Sizes and Discounts",
      "Цены API генерации изображений: ставки за tokens, размеры и скидки",
    ...
    description: tr(
      "Understand AI image API pricing for Nano Banana 2 and GPT Image 2: usage legs, official token rates, fixed 1K/2K/4K image costs, cached input, the 50% B2C discount and cost per accepted asset.",
      "Разберитесь в цене AI image API для Nano Banana 2 и GPT Image 2: usage legs, официальные ставки за tokens, фиксированная цена 1K/2K/4K, cached input, скидка 50% для B2C и цена принятого ассета.",
