...
export const spec: ImageSeoSpec = {
    ...
    title: tr(
      "Image Editing API: GPT Image 2 vs Nano Banana 2",
      "Редактирование изображений через API: GPT Image 2",
    ...
    description: tr(
      "Image editing API guide: build a production edit workflow on GPT Image 2 or Nano Banana 2 — reference contracts, cost math, validation, safe retries.",
      "Гайд по API редактирования изображений: production-пайплайн на GPT Image 2 или Nano Banana 2 — reference contracts, расчёт цены, валидация, retries.",
    ...
    sections: [
      section(
        ...
        [
          ...
          tr(
            { type: "link", text: "Full comparison of both editing contracts and rates", href: "/docs/learn/nano-banana-2-vs-gpt-image-2" },
            { type: "link", text: "Полное сравнение обоих контрактов редактирования и ставок", href: "/docs/learn/nano-banana-2-vs-gpt-image-2" },
            { type: "link", text: "两种编辑契约与费率的完整对比", href: "/docs/learn/nano-banana-2-vs-gpt-image-2" },
            { type: "link", text: "두 편집 계약과 요금의 전체 비교", href: "/docs/learn/nano-banana-2-vs-gpt-image-2" },
          ),
        ],
      ),
      section(
    ...
    "imageConfig": { "imageSize": "1K", "aspectRatio": "1:1" }
      ...
      section(
        ...
        [
          ...
          tr(
            { type: "link", text: "Every token rate behind an edit bill, explained", href: "/docs/learn/image-generation-api-pricing" },
            { type: "link", text: "Все ставки за tokens, из которых складывается счёт за edit", href: "/docs/learn/image-generation-api-pricing" },
            { type: "link", text: "构成编辑账单的各项 token 费率详解", href: "/docs/learn/image-generation-api-pricing" },
            { type: "link", text: "edit bill을 구성하는 모든 token 요금 설명", href: "/docs/learn/image-generation-api-pricing" },
          ),
        ],
      ),
      section(
