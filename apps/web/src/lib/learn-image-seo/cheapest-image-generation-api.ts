...
export const spec: ImageSeoSpec = {
    ...
    title: tr(
      "Cheapest Image Generation API: Real Cost Compared",
      "Самый дешёвый API генерации изображений",
    ...
    description: tr(
      "Cheapest image generation API for your workload: Nano Banana 2 vs GPT Image 2 on settled usage, acceptance rate and the 50% B2C discount.",
      "Самый дешёвый API генерации изображений для вашей задачи: Nano Banana 2 и GPT Image 2 по settled usage, acceptance rate и скидке 50%.",
    ...
    sections: [
      section(
        ...
        [
          ...
          tr(
            { type: "link", text: "Head-to-head: contracts, rates and the bake-off method", href: "/docs/learn/nano-banana-2-vs-gpt-image-2" },
            { type: "link", text: "Прямое сравнение: контракты, ставки и методика bake-off", href: "/docs/learn/nano-banana-2-vs-gpt-image-2" },
            { type: "link", text: "正面对比：契约、费率与对比评测方法", href: "/docs/learn/nano-banana-2-vs-gpt-image-2" },
            { type: "link", text: "정면 비교: 계약, 요금, bake-off 방법", href: "/docs/learn/nano-banana-2-vs-gpt-image-2" },
          ),
        ],
      ),
      section(
  ...
  -d '{"model":"gpt-image-2","prompt":"A clean studio product photograph","background":"opaque","quality":"low","size":"auto"}'`),
      ...
      section(
        ...
        [
          ...
          tr(
            { type: "link", text: "Prepaid plans: any whole-dollar amount, balance never expires", href: "/plans" },
            { type: "link", text: "Prepaid-тарифы: любая целая сумма в долларах, баланс не сгорает", href: "/plans" },
            { type: "link", text: "预付方案：任意整数美元充值，余额不过期", href: "/plans" },
            { type: "link", text: "prepaid 요금제: 임의의 정수 달러, 잔액 만료 없음", href: "/plans" },
          ),
        ],
      ),
    ],
