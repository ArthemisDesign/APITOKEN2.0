...
export const spec: ImageSeoSpec = {
  ...
  title: tr(
    "Nano Banana 2 API Cost: Exact Prices and 50% B2C Savings",
    "Стоимость Nano Banana 2 API: точные цены и экономия 50% для B2C",
  ...
  description: tr(
    "Calculate Nano Banana 2 image-generation cost for 1K, 2K and 4K output. Exact official image tokens, apiToken.sale's 50% B2C price, worked batch math and budgeting safeguards.",
    "Рассчитайте стоимость генерации Nano Banana 2 для 1K, 2K и 4K: точные image tokens, цена apiToken.sale со скидкой 50% для B2C, готовый расчёт пакета и контроль бюджета.",
